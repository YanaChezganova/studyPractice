...
class AdapterRecyclerViewWithWatchedFilms @Inject constructor() :
    ...
    fun setData(data: List<Movie>, watchedId: List<Int>, onClick: (Movie) -> Unit) {
        this.data = data
    ...
    override fun onBindViewHolder(holder: MovieViewHolder, position: Int) {
        ...
        with(holder.binding) {
            ...
            if (watchedId.contains(filmId)) blueShadow.visibility = View.VISIBLE
