...
class Transform() {
    ...
    fun adapterPostGenres(): JsonAdapter<Genres>
    {
        return moshi().adapter(Genres::class.java)
    }
    fun adapterPostCountries(): JsonAdapter<Countries>
    {
        return moshi().adapter(Countries::class.java)
    }
     val countryString = """ {
